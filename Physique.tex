...
\begin{table}[H]
    ...
    \begin{tabular}{@{}|p{9cm}|p{10cm}@{}|}
        ...
        Critère de brouillage & $l_c \simeq \delta_{1/2} $ \ \ $?$ \\ \hline 
...
\begin{table}[H]
    ...
    \begin{tabular}{@{}|p{9cm}|p{10cm}@{}|}
        ...
        Deuxième principe de la thermodynamique (Pour un système avec suffisement de particules) & $\d S = \delta S_{\text{crée}} + \delta S_{\text{échangée}}$ \\ \hline
        Propriétés de $S_{\text{crée}}$ & $\delta S_{\text{crée}} > 0 \unit{\J\per\kelvin}$ \\ \hline
        Propriétés de $S_{\text{échangée}}$ & $\displaystyle\delta S_{\text{échangée}} = \sum\limits_{k\in\text{Paroix}} \frac{\delta Q_k}{T_k}$ \\ \hline 
        Exemple imbatable de la non-conservation de l'entropie & $\Omega = \left\{\text{Univers}\right\}, \d S_{\text{Univers}} = \delta S_{\text{crée}} + \underbrace{\delta S_{échangé}}_{=0} > 0$ \\ \hline 
        Rendement ou éfficacité de Carnot & $\eta = \frac{\text{grandeur énergétique utile}}{\text{grandeur énergétique coûteuse}}$ \\ \hline
        Transformation réversible & $S_{\text{crée}} = 0$ \\ \hline
